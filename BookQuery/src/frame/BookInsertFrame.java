...
public class BookInsertFrame extends JFrame{
	...
	public void action(){
		...
		JLabel bookInfo = new JLabel("图书信息插入");    //创建 JLabel 对象，用于短文本字符串或图像或二者的显示区
		...
		insertButton.addActionListener(
				new ActionListener(){
					public void actionPerformed(ActionEvent e){
						...
						book.setPosition(positionField.getText().toString());
