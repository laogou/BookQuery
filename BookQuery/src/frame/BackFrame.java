...
public void action(){
		...
		JButton insertButton = new JButton("归还");    //创建 JButton 对象，实现按钮功能
		...
		JLabel bookInfo = new JLabel("要归还的图书信息");    //创建 JLabel 对象，用于短文本字符串或图像或二者的显示区
		...
		insertButton.addActionListener(
				new ActionListener(){
					public void actionPerformed(ActionEvent e){
						...
						if(bookManager.back(nameField.getText(),amountField.getText(),publisherField.getText(),authorField.getText())){
							...
							JOptionPane.showMessageDialog(null, "归还失败，请按照借阅时信息归还", 
									"Insert Form", JOptionPane.INFORMATION_MESSAGE);
						}
