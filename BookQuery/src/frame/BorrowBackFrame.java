...
public class BorrowBackFrame extends JFrame{
...
public void action(){
		...
		JButton insertButton = new JButton("借书");    //创建 JButton 对象，实现按钮功能
		...
		JButton backButton = new JButton("还书");    //创建 JButton 对象，实现按钮功能
		backButton.setBounds(380, 400, 90, 40);    //设置 JButton 对象在窗口中的位置和大小
		backButton.setIcon(new ImageIcon("img/flush.png"));    //为 JButton 对象添加图片
		...
		insertButton.addActionListener(
				new ActionListener(){
					public void actionPerformed(ActionEvent e){
						...
						//创建 Borrow 对象，并进行事件处理
						BorrowFrame borrowFrame = new BorrowFrame();
						borrowFrame.action();
						borrowFrame.createWindow();
					}
				});
		//还书按钮事件处理
